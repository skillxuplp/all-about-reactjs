    ...
    <div>
      ...
      <main>
        <section id="products-info">
          ...
          <ul>
            {PRODUCTS_INFO.map((productItem) => (
              <ProductsInfo key = {productItem.productId} {...productItem} onProductSelect = {() => handleProductSelect(productItem.productId)} />
            ))}
            {/* <ProductsInfo 
        ...
        <section>
        {PRODUCTS_INFO.map((productItem) => (
          selectedProduct === productItem.productId ? (<ProductsInfo {...productItem} />) : undefined
            ))}
        </section>
